...
var limlted = (function () {
  ...
  function crollAjax() {
    ...
    //   var doct = $(".shang").offset().top;
    //   var sagH = $(".shang").height();
    //   console.log(doct + sagH);
    //   if ($(this).scrollTop() + winH >= doct + sagH) {
    //     if (page <= 1) {
    //       if (flage) {
    //         $(".shang").html(
    //           '<div class=rush-product-item relative border-bottom><a href="" class="flex"><img src="" alt="" class="lazy-img rush-img flex-child-noshrinh"></img><div class="flex flex-col flex-justify-between flex-child-grow"><div><p class="font-15 lines-2"></p><p class="grey-9 selling-point"></p></div><div class="flex flex-justify-between flex-align-end flex-1"><div class="flex-child-grow"><div class="flex flex-align-end"><div class="flex flex-align-end margin-right"><span class="font-12 bold"></span><span class="font-20 bold"></span></div><del class="grey-9 font-12"></del></div><div class="percent flex flex"><p class="flex-child-grow><span class="font-12"></span><i></i></p></div></div><div class="rush-btn red-bg"></div></div></div></a></div>'
    //         );
    //         flage = false;
    //         $.ajax({
    //           type: "get",
